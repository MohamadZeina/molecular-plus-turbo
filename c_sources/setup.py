...
if not DEBUG_MODE:
    if os_name == "Windows":
        ext_modules = [Extension(
            module_name,
            ['core.pyx'],
            extra_compile_args=['/Ox', '/openmp:llvm', '/GT', '/arch:AVX512', '/fp:fast', '/MD']
        )]
        ...
        ext_modules = [Extension(
            module_name,
            ['core.pyx'],
            extra_compile_args=['-O3', '-mavx512f', '-ffast-math', '-fno-builtin', '-fopenmp'],
        ...
        ext_modules = [Extension(
            module_name,
            ['core.pyx'],
            extra_compile_args=['-mavx512f', '-O3', '-ffast-math', '-fno-builtin','-arch','arm64','-arch','arm64e','-arch','x86_64', '-Xclang', '-fopenmp', '-isystem./openmp/include'],
